...
, FaceEmbedding, LandmarksDetector
...
if __name__ == '__main__':
    ...
    while True:
        ...
        # Grab a single frame
        frame = cv2.imread('./AccessControl/capturePicture.jpeg')

        checkProgRun = os.path.exists("./AccessControl/LetProgRun.txt")

        bool([frame])
        bool([checkProgRun])

        if checkProgRun is True:
                ...
                if process_this_frame:
                    ...
                    for i, face_rect in enumerate(detected_faces):
                        ...
                        if prob > 0.5:
                            ...
                            if 'Glauber' in face_names:
                            
                                print('LetDoorOpen')
                                f= open("./AccessControl/LetDoorOpen.txt","w+")
                                cv2.imshow('ImageLetAccess',frame)
                                f.write("Let Door Open")
                                f.close()
